		...
		<div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow overflow-hidden">
			...
			<div className="p-6">
				...
				<div className="flex items-center justify-between">
					<span className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">{property.price} TL</span>
					<Button className="bg-indigo-600 hover:bg-indigo-700 text-white">Detaylar</Button>
				</div>
			</div>
		</div>
	)
